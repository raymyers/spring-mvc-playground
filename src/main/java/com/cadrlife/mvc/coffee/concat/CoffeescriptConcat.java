...
// 			System.out.println("nextFileDef = " + nextFileDef.getName());
	...
	public static void main(String[] args) throws IOException {
		List<File> root = Lists.newArrayList();
		List<File> include = Lists.newArrayList();
		String jsDir = "/home/ray/Documents/workspace-sts-2.8.0.M2/spring-mvc-playground/src/main/webapp/WEB-INF/js/";
		root.add(new File(jsDir + "home.coffee"));
		include.add(new File(jsDir + "app/a1.coffee"));
		include.add(new File(jsDir + "app/a2.coffee"));
